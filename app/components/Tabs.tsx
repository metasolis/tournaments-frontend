            ...
            <div id="equal-width-elements-1" role="tabpanel" aria-labelledby="equal-width-elements-item-1">
                <div className='flex-auto justify-center items-center h-auto w-auto p-2'>
                    ...
                    <div>
                        ...
                        {/* Text */}
                        <p className="text-base mt-2 mx-3 py-1 text-left text-gray-400">Available: 5 WTR (<u>max</u>)</p>
                        
                        {/* Confirm Stake Button */}
                        <button className="my-5 px-10 py-2 bg-watchtower-gold content-center text-black rounded-md shadow hover:shadow-lg font-bold" >
                        <TbDiscountCheckFilled size={20} />Confirm Stake
                        </button>
                    </div>

                    {/* <div className='objects-center'>
                        <button className="my-5 px-10 h-auto bg-watchtower-gold text-black rounded-md shadow hover:shadow-lg font-bold" >
                        <TbDiscountCheckFilled size={20} />Confirm Stake
                        </button>
                    </div> */}
                </div>
